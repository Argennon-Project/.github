...
An Argennon validator is light enough to be implemented as a smart contract. By deploying an Argennon validator on
another blockchain, Argennon is able to use older blockchains as an extra layer of security.
